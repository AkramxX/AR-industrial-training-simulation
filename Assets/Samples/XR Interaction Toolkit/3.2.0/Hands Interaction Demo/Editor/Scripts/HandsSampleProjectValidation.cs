...
{
    /// <summary>
    /// Unity Editor class which registers Project Validation rules for the training interaction module,
    /// checking that other required training packages are installed.
    /// </summary>
    static class HandsSampleProjectValidation
    {
        const string k_SampleDisplayName = "Training Interaction";
        ...
        static readonly List<BuildValidationRule> s_BuildValidationRules = new List<BuildValidationRule>
        {
            new BuildValidationRule
            {
                ...
                Message = $"[{k_SampleDisplayName}] XR Hands ({k_HandsPackageName}) package must be installed or updated to use this training module.",
                Category = k_Category,
            ...
            {
                IsRuleEnabled = () => s_HandsPackageAddRequest == null || s_HandsPackageAddRequest.IsCompleted,
                Message = $"[{k_SampleDisplayName}] XR Hands ({k_HandsPackageName}) package must be at version {s_RecommendedHandsPackageVersion} or higher to use the latest training features.",
                Category = k_Category,
            ...
            new BuildValidationRule
            {
                ...
                Message = $"[{k_SampleDisplayName}] {k_HandVisualizerSampleName} training asset from XR Hands ({k_HandsPackageName}) package must be imported or updated to use this module.",
                Category = k_Category,
            ...
            new BuildValidationRule
            {
                Message = $"[{k_SampleDisplayName}] {k_StarterAssetsSampleName} training asset from XR Interaction Toolkit ({k_XRIPackageName}) package must be imported or updated to use this module. {GetImportSampleVersionMessage(k_Category, k_StarterAssetsSampleName, ProjectValidationUtility.minimumXRIStarterAssetsSampleVersion)}",
                Category = k_Category,
            ...
            new BuildValidationRule
            {
                ...
                Message = $"[{k_SampleDisplayName}] Shader Graph ({k_ShaderGraphPackageName}) package must be installed for materials used in this training module.",
                Category = k_Category,
